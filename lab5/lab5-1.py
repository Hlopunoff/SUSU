...
print(name != 'John' or age != 17)  # Напишите логическое выражение со значением "человека зовут John или ему 17" с
# использованием оператора not
...
# Напишите логическое выражение, проверяющее следующее высказывание: "Человека зовут не John, он старше 20 лет и
# первая буква его имени не ‘E’".

print(name != 'John' and age > 20 and not(name[0] == 'E'))
