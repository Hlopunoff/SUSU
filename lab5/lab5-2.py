""" Ключевое слово if используется для построения условного оператора, который выполняет определенный код после
проверки некоторого условия (логического выражения) на истинность.
